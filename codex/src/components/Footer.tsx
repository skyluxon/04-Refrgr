...
export function Footer() { return <footer className="bg-[#06172f] py-12 text-slate-300">
  <div className="container-site grid gap-8 md:grid-cols-2">
    ...
    <div className="text-sm md:text-right"><p>{contact.phoneLabel}</p><p>{contact.hours}</p><p>{contact.address}</p><div className="mt-4 flex gap-4 md:justify-end"><Link href="/contact">상담문의</Link><span>개인정보 처리방침 준비 중</span></div></div>
  </div>
</footer> }
